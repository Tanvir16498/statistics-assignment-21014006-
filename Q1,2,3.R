...
setwd("C:\statistics  assignment")

# Verify if the file exists
file.exists("C:\statistics  assignment.xls")
...
get_salary_wages
# Ensure that salary_wages data has 26 points
...
# If you need exactly 26 observations, you can either take the first 26, sample 26 randomly, or apply some selection method.
# Randomly select 26 observations from the combined data
set.seed(123)  # For reproducibility
salary_wages_sample_26 <- sample(salary_wages_sample, 26, replace = FALSE)
salary_wages_sample_26
# View the sample of 26 observations
print(salary_wages_sample_26)
...
set.seed(123)  # For reproducibility
salary_wages_sample_26 <- sample(combined_salary_wages, 26, replace = FALSE)

# Get frequency distribution for the sample data
frequency_distribution_sample <- get_frequency_distribution(salary_wages_sample_26)

# Print the frequency distribution for the sample
cat("Frequency Distribution for Sample of 26 Observations:\n")
...
print_analysis(salary_wages_sample_23, "Salary Wages Sample of 26 Observations")
...
plot_histogram(frequency_distribution_sample, "Histogram of Salary Wages Sample of 26 Observations")
